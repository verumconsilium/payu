...
class PaymentMethods
{
    ...
    /**
     * payment methods available in PayU including its payment method type
     *
     */
     ...
     * @return boolean
     */
    public static function isAllowedCashPaymentMethod($paymentMethod)
    {
