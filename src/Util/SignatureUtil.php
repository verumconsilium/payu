    ...
    /** MD5 algorithm used */
     ...
     public static function buildSignature($order, $merchantId, $key, $algorithm)
     {
         ...
         if (SignatureUtil::MD5_ALGORITHM == $algorithm) {
             return md5($message);
         } elseif (SignatureUtil::SHA_ALGORITHM == $algorithm) {
             return sha1($message);
         } else {
