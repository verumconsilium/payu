...
class RequestPaymentsUtil extends CommonRequestUtil
{
     ...
     * @return stdClass the ping request built
     */
    public static function buildPingRequest($lang=null)
    {
        if (!isset($lang)) {
            $lang = PayU::$language;
        }
     ...
     * @param string $lang language to be used
     *
     * @return stdClass The complete bank list response
     */
     ...
     * @param string $lang language to be used
     *
     * @return stdClass The complete payment method information from API
     */
    ...
    public static function buildPaymentRequest($parameters, $transactionType, $lang = null)
    {
        ...
        } elseif (TransactionType::VOID == $transactionType
    ...
    private static function buildTransactionRequest($parameters, $lang)
    {
        ...
        } elseif (CommonRequestUtil::getParameter($parameters, PayUParameters::TOKEN_ID) != null) {
        ...
        if (CommonRequestUtil::getParameter($parameters, PayUParameters::INSTALLMENTS_NUMBER) != null) {
            $transaction = RequestPaymentsUtil::addExtraParameter(
                    $transaction,
    ...
    private static function buildOrderRequest($parameters, $lang)
    {
        ...
        RequestPaymentsUtil::buildOrderAdditionalValues(
 
            CommonRequestUtil::getParameter($parameters, PayUParameters::CURRENCY),
    ...
    private static function addPSEExtraParameters($transaction, $parameters)
    {
        ...
        if ($pseFinancialInstitutionCode != null) {
            $transaction = RequestPaymentsUtil::addExtraParameter(
                $transaction,
                    PayUKeyMapName::FINANCIAL_INSTITUTION_CODE,
